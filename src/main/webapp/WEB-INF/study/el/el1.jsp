    ...
    <div class="container">
    	...
    	<div>
    		...
    		<ol>
    			<li>Server
    				<ul>
    					<li>Application : 전역..</li>
    					<li>Session : 브라우저와 함꼐..</li>
    					<li>Request : request에 의해서 전송시에만 유효. 1칸 전송 이후 소멸</li>
...
%>
	...
	<hr/>
	<p>앞페이지에서 값을 넘겨줄 때는 '$ {param.xxxx}'로 받는다. </p>
	atom = ${param.atom }<br/>
	su1 = ${param.su1 }<br/>
	su2 = ${param.su2 }<br/>
	<hr/>
